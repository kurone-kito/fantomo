...
public class Constants : UdonSharpBehaviour
{
    ...
    public const float LOAD_INTERVAL = 0.2f;

    /// <summary>解錠状態を示すフラグ定数。</summary>
    public const int LOCK_STATE_UNLOCKED = 0;

    /// <summary>自プレイヤーによる施錠状態を示すフラグ定数。</summary>
    public const int LOCK_STATE_LOCKED_BY_ME = 1;

    /// <summary>他プレイヤーによる施錠状態を示すフラグ定数。</summary>
    public const int LOCK_STATE_LOCKED_BY_ENEMY = 2;

    /// <summary>施錠状態の固定を示すフラグ定数。</summary>
    public const int LOCK_STATE_DISABLED = 4;

    /// <summary>鍵の設置数。</summary>
    public const int NUM_KEYS = 9;

    /// <summary>地雷の設置数。</summary>
    public const int NUM_MINES = 9;

    /// <summary>最大エントリー可能数。</summary>
    public const int NUM_PLAYERS = 3;

    /// <summary>部屋フラグにおける、ビット数。</summary>
    public const byte ROOM_BIT_MAX = 8;

    /// <summary>ゲームフィールドの X 軸における部屋数。</summary>
    /// <remarks>
    /// ビット演算の関係上、この値は 11 以下である必要があります。
    /// </remarks>
    public const int ROOMS_WIDTH = 8;

    /// <summary>扉を削除して、袋小路を形成する比率。</summary>
    public const float ROOM_REMOVE_DOOR_RATE = 0.01f;
    ...
    /// </remarks>
    public const int NUM_ROOMS = ROOMS_WIDTH * ROOMS_WIDTH;
    ...
    /// </remarks>
    public const int NUM_INSTANTIATES = NUM_KEYS + NUM_MINES + NUM_ROOMS + 2;
}
